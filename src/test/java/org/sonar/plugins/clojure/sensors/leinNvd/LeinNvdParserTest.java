...
import org.sonar.plugins.clojure.sensors.kibit.KibitIssueParser;
...
import static org.sonar.plugins.clojure.sensors.leinNvd.LeinNvdSensor.readFile;
...
public class LeinNvdParserTest {
    ...
    public void testParse() throws IOException {
        String json = readFile("src/test/java/org/sonar/plugins/clojure/sensors/leinNvd/report.json", Charset.forName("UTF-8"));
